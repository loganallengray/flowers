...
const inexpensiveFlowers = () => {
    ...
    /* 
        iterate through flowers array with a for... of, 
        check the price of flowers using an if statement, 
        push the flower to the filtered flower array 
    */
...
const zoneFlowers = () => {
    ...
    /* 
        iterate through flowers array with a for... of,
        check the USDA zone of the flower with an if statement,
        which uses a .includes() method to check if it has the right zone,
        push the flower to the filtered fower array 
    */
...
const orangeFlowers = () => {
    ...
    /* 
        iterate through flowers array with a for... of,
        check the color with an if statement using .includes(),
        push the flower to filteredflowers if orange 
    */
...
const flowersAsHTML = () => {
    ...
    */
    ...
    /* 
        iterate through flower arrays with for... of,
        add to the flowerHTMLString the articles with correct syntax,
        correct syntax being: 
            the flower name wrapped in a h1 tag,
            color and usda zone headers in h2 tags,
            colors wrapped in section tags,
            zones wrapped in div tags,
            everything wrapped in article tags,
            linebreaks (\n) and horizontal tabs (\t) as needed
    */
